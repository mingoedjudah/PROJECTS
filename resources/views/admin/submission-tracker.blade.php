                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a
                                                ...
                                                class="breadcrumb-link"  style="cursor: default; color: #3d405c;">Submission Tracker</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped table-bordered first">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="progress">
                                                    <div class="progress-bar" role="progressbar" style="width: {{ $progressData[$user->user_login_id] }}%;" aria-valuenow="{{ $progressData[$user->user_login_id] }}" aria-valuemin="0" aria-valuemax="100">
                                                        {{ number_format($progressData[$user->user_login_id], 2) }}%
                                                    </div>
                                                </div>
                                            </td>
                                           <td>
                                        <a href="{{ route('admin.view-folder', ['user_login_id' => $user->user_login_id]) }}" class="btn btn-info">View</a>
                                    </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
