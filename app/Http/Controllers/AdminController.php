  ...
  public function viewAccomplishmentFaculty($user_login_id, $folder_name_id)
{
    ...
    return view('admin.accomplishment.view-accomplishment', [
        'folder' => $folder,
        'folderName' => $folder->folder_name,
        'files' => $files, // No need for grouped files anymore
        'folders' => $folders,
        'firstName' => $user->first_name,
        'surname' => $user->surname,
        'notifications' => $notifications,
 ...
 public function showSubmissionTracker()
{
    ...
    // Get all users with role 'faculty' or 'faculty-coordinator' and include faculty_code
    ...
    foreach ($allUsers as $user) {
        ...
        foreach ($mainFolders as $mainFolder) {
            ...
            foreach ($subFolders as $subFolder) {
                ...
                // Calculate sub-folder progress (100% if any files are submitted)
                $subFolderProgress = ($totalFiles > 0) ? 100 : 0;
                $mainFolderProgress += $subFolderProgress;
            }

            // Average progress across subfolders
        ...
        // Average progress across main folders
...
public function viewFolder($user_login_id)
{
    ...
    // Retrieve the user based on the provided user_login_id
